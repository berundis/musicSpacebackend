...
local = Venue.create(password: "local", email: "local@gmail.com", name: "Local", description: "dirty", genres: "punk, rock", profile_img:"https://s3-media3.fl.yelpcdn.com/bphoto/DxHolPdLR3R0jDj6Nhtmyg/ls.jpg", location: "Santurce")
club77 = Venue.create(password: "club", email: "club77@gmail.com", name: "Club 77", description: "punk", genres:"all", profile_img: "https://i.ytimg.com/vi/6jFPIH6-Zg4/maxresdefault.jpg", location: "Rio Piedras")
